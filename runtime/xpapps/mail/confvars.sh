...
MOZ_APP_VERSION=`$PYTHON ${_topsrcdir}/runtime/build/version2k.py --version ${_topsrcdir}/apps/mail/config/version.txt`
MOZ_APP_VERSION_DISPLAY=$MOZ_APP_VERSION
MOZ_BRANDING_DIRECTORY=apps/mail/branding/unofficial
MOZ_OFFICIAL_BRANDING_DIRECTORY=apps/mail/branding/official
